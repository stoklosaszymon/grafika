...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void Podstawa (GL2 gl2,int n , int r)
	{
		...
		{	
			...
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[5],5);
			gl2.glVertex3d((double)(r*Math.cos(i*2*Math.PI/n)),1,(double)(r*Math.sin(i*2*Math.PI/n)));// gl2.glVertex3d(x , y ,z ) 
	...
	public void n_Triangle (GL2 gl2,int n , int r, int h)
	{
	    ...
	    for (int i=0;i<=n;i++)
	    {
	    	...
	    	gl2.glBegin(GL2.GL_POLYGON);	
	    	gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[1],4);
			gl2.glVertex3d((double)(r*Math.cos(i*2*Math.PI/n)),1, (double)(r*Math.sin(i*2*Math.PI/n))); 
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[10],7);
			gl2.glVertex3d(0, h, 0);
			i++;
			gl2.glMaterialfv(gl2.GL_FRONT_AND_BACK,gl2.GL_AMBIENT_AND_DIFFUSE,materials[1],8);
			gl2.glVertex3d((double)(r*Math.cos(i*2*Math.PI/n)),1,(double)(r*Math.sin(i*2*Math.PI/n)));
			i--;
		    gl2.glEnd();
	    }
	...
	public void init(GLAutoDrawable drawable) {
		...
		gl2.glLightfv(GL2.GL_LIGHT1,GL2.GL_AMBIENT ,color,1);
